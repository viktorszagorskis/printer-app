package dev.ocma.application.views;
...
import dev.ocma.application.views.checkoutform.CheckoutFormView;
import dev.ocma.application.views.dashboard.DashboardView;
import dev.ocma.application.views.empty.EmptyView;
import dev.ocma.application.views.helloworld.HelloWorldView;
import dev.ocma.application.views.pageeditor.PageEditorView;
...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        Span appName = new Span("Printer Services");
